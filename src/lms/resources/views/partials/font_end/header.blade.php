        ...
        <div class="container-fluid clearfix">
            ...
            <div class="header-inner d-flex align-items-center justify-content-between">
                <div class="logo-outer d-lg-flex align-items-center">
                    <div class="logo"><a href="index.html"><img src="{{asset('assets/images/logos/ptit.png')}}" style="width: 100px; height: 100px;" alt="Logo" title="Logo"></a></div>
                ...
                <div class="menu-btn-sidebar d-flex align-items-center">
                    ...
                    @endphp
                    <button><i class="far fa-user-circle"></i> {{isset($user)?$user->first_name:''}}</button>
                    @if(isset($user))
                    <a href="{{route('logout')}}" style="margin-left: 5px;"><i class="fas fa-sign-out-alt"></i></a>
                    @else
                    <a class="text-lg" href="{{route('login')}}" style="margin-left: 5px;"><i class="fas fa-sign-in-alt"></i></a>
                    @endif
                    <!-- menu sidbar -->
