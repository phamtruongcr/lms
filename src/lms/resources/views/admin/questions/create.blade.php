@extends('layouts.app')
@section('title',('form/question.Create a question'))
...
<h2>{{__('form/question.Create a question') }}</h2>
<div>
  <form method="post" action="{{ route('question.store') }}">
  @include('admin/questions/_question_form')
  <button type="submit" class="btn btn-primary">{{__('form/question.Create') }}</button>
  </form>
</div>
@stop
